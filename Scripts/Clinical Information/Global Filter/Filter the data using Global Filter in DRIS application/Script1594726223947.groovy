...
CustomKeywords.'com.dris.LoginMessage.captuteScreenshot'('Filter the data using Global Filter-SystemSearch')
...
CustomKeywords.'com.dris.LoginMessage.captuteScreenshot'('Filter the data using Global Filter-Search')
...
CustomKeywords.'com.dris.LoginMessage.captuteScreenshot'('Filter the data using Global Filter- Clear')
