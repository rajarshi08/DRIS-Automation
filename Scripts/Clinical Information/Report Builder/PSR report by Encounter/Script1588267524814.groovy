...
WebUI.click(findTestObject('Clinical Information/Report Builder/Page_Search/button_Clear'))
...
WebUI.click(findTestObject('Clinical Information/Report Builder/Page_Search/System_Input'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(2)

Driver.findElement(By.xpath(('//*[@id="Systems_listbox"]/li[text()=\'' + sSystem) + '\']')).click()

WebUI.click(findTestObject('Clinical Information/Report Builder/Page_Search/button_Search'))
...
WebUI.setText(findTestObject('Object Repository/Clinical Information/Report Builder/Page_Clinical Information/input_Entity Receiving PHI_EntityReceivingPHI'), 
    '12')
