...
WebUI.click(findTestObject('Patient Accounting/Page_AR Report/Transaction/Credit Report/a_Credit Reports'))

BannerName = WebUI.getText(findTestObject('Patient Accounting/Page_AR Report/Transaction/Credit Report/div_Credit - Credit Report'))

WebUI.verifyMatch(BannerName, 'Credit - Credit Report', true)

WebUI.click(findTestObject('Patient Accounting/Page_AR Report/Transaction/Credit Report/input_Filter Button'))

BannerName = WebUI.getText(findTestObject('Patient Accounting/Page_AR Report/Transaction/Credit Report/span_Credit - Credit Report Results'))

WebUI.verifyMatch(BannerName, 'Credit - Credit Report Results', true)

String fileName = GlobalVariable.ScreenShotPath + '\\CreditReportUI.png'

println('+++++++++ fileName :' + fileName)

WebUI.takeScreenshot(fileName)

WebUI.click(findTestObject('Patient Accounting/Page_AR Report/Transaction/Credit Report/a_Export'))
