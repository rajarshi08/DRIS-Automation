...
WebUI.verifyElementPresent(findTestObject('Patient Accounting/Page_AR Summary/Dashboard Tab/div_Dashboard_AR Balance By Financial Class_Card'), 
    2)

WebUI.verifyElementPresent(findTestObject('Patient Accounting/Page_AR Summary/Dashboard Tab/div_Dashboard_AR Balance Trend By Month_Card'), 
    2)

WebUI.verifyElementPresent(findTestObject('Patient Accounting/Page_AR Summary/Dashboard Tab/div_Dashboard_AR Balance_Card'), 
    2)
